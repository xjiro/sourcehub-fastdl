...
Scheme
{
	...
	Colors
	{
		...
		"BrightBaseText"	"200 200 200 255"	// brightest text
		"SelectedText"		"255 255 255 255"	// selected text
		"DimBaseText"		"190 190 190 255"	// dim base text
		"LabelDimText"		"170 170 170 255"	// used for info text
		"ControlText"		"216 216 216 255"	// used in all text controls
		"BrightControlText"	"255 255 255 255"	// use for selected controls
		"DisabledText1"		"170 170 170 255"	// disabled text
		"DisabledText2"		"25 25 25 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"117 117 117 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"100 100 100 255"		// background color of controls
		"ControlDarkBG"		"150 150 150 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"85 0 0 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"160 115 40 255"	// background color of any selected text or menu item
		"SelectionBG2"		"50 0 0 255"		// selection background in window w/o focus
		"ListBG"			"80 80 80 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"255 255 255 255"
		"TitleDimText"		"145 145 145 255"
		"TitleBG"			"77 77 77 0"
		"TitleDimBG"		"77 77 77 0"
		
		// slider tick colors
		"SliderTickColor"	"202 202 202 255"
		"SliderTrackColor"	"31 31 31 255"

		// border colors
		"BorderBright"		"145 145 145 255"	// the lit side of a control
		"BorderDark"		"17 17 17 255"		// the dark/unlit side of a control
	...
	BaseSettings
	{
		...
		"TitleBarIcon"				"resource/icon_ttt"
		"TitleBarDisabledIcon"		"resource/icon_ttt_disabled"
